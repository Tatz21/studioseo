...
- **Visual Depth:** Multi-layered surfaces, subtle glassmorphism (`backdrop-filter: blur(16px)`), soft radial glow highlights, and 1px translucent borders.
...
| `--bg-surface-glass` | `rgba(17, 24, 39, 0.75)` | Glassmorphic overlays with blur |
